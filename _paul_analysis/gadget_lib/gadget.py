...
import readsnap
def readsnap(sdir,snum,ptype,h0=0,cosmological=0,skip_bh=0,four_char=0,header_only=0,loud=0,skip_sfr=0):
    return gadget_lib.readsnap.readsnap(sdir,snum,ptype,h0=h0,\
            cosmological=cosmological,skip_bh=skip_bh,four_char=four_char,header_only=header_only,loud=loud,skip_sfr=skip_sfr);
...
def load_allstars_hsml(snapdir,snapnum,cosmo=0,use_rundir=0,four_char=0,use_h0=1):
    return gadget_lib.load_stellar_hsml.load_allstars_hsml(snapdir,snapnum,cosmo=cosmo,\
        use_rundir=use_rundir,four_char=four_char,use_h0=use_h0);
