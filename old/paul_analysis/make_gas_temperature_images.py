...
BAD_PATH = '/n/home00/lkelley/illustris/illustris_python'
if BAD_PATH in sys.path:
    sys.path.remove(BAD_PATH)

PATH_LIB = os.path.realpath(os.path.split(__file__)[0])
PATH_LIB = os.path.join(PATH_LIB, "Python", "")
if PATH_LIB not in sys.path:
    sys.path.append(PATH_LIB)
    print("Added '{}' to sys.path".format(PATH_LIB))
