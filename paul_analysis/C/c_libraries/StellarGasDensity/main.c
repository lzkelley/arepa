...
void set_particle_pointer(int Nsize, float* x, float* y, float* z, float* mass);
                      ...
                      int DesNgb, float Hmax, float* H_OUT)
{
    ...
    double h, Ngb, Rho, dx, dy, dz, r, r2, u, hinv, hinv3, hinv4, wk, dwk, mj_wk;
    int n, j;
    ...
    set_particle_pointer(N_gas, x_gas,y_gas,z_gas, m_gas);
